...
type RaftServiceClient interface {
	RequestVote(ctx context.Context, in *RequestVoteArgs, opts ...grpc.CallOption) (*RequestVoteArgsResponse, error)
...
func (c *raftServiceClient) RequestVote(ctx context.Context, in *RequestVoteArgs, opts ...grpc.CallOption) (*RequestVoteArgsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RequestVoteArgsResponse)
...
type RaftServiceServer interface {
	RequestVote(context.Context, *RequestVoteArgs) (*RequestVoteArgsResponse, error)
...
func (UnimplementedRaftServiceServer) RequestVote(context.Context, *RequestVoteArgs) (*RequestVoteArgsResponse, error) {
...
var RaftService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "consensusmodule.proto",
}
